...
```text
请把这台 Mac 上已有的 Feishu Codex Bridge 安全升级到私有测试 tag v0.4.0-macos-rc.2。运行任何命令前先要求我确认当前 Codex 对话已设为 Full access，然后完整读取私有仓库 ninmon/feishu-codex-bridge-private 中该 tag 的 AGENTS.md、docs/INSTALL_MACOS.md 和 Release Note。
