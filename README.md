...
> **Beta**：当前版本仍依赖 Codex App Server 的实验性 WebSocket 接口，适合个人和小团队试用，不建议作为无人值守的生产服务。安装时请使用固定 release tag；平台版本选择见[版本与发布历史](#版本与发布历史)。
...
安装和升级都应使用与平台对应的固定 tag，不要让安装代理改用持续变化的 `main`。当前项目不发布 npm 包，`package.json` 中的版本号不是安装版本依据。

| 平台 | 推荐版本 | 适用范围 |
| --- | --- | --- |
| macOS | `v0.4.0-macos-rc.9` | 私有多用户候选版 |
| Windows | `v0.4.0-windows-rc.5` | 私有多用户候选版 |
| Windows | `v0.3.2-windows-rc.4` | 公开基线 |

<details>
<summary>查看完整版本边界与候选版演进</summary>
...
相关演进记录：[Bridge pointer 生命周期](https://github.com/Jiakai-Zhang/feishu-codex-bridge/pull/8) · [单张持久流式卡片](https://github.com/Jiakai-Zhang/feishu-codex-bridge/pull/9) · [长回答文档与媒体转发](https://github.com/Jiakai-Zhang/feishu-codex-bridge/pull/10) · [飞书入站附件 relay](https://github.com/Jiakai-Zhang/feishu-codex-bridge/pull/12) · [静态检查基线](https://github.com/Jiakai-Zhang/feishu-codex-bridge/pull/19)
